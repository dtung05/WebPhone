...
<div class="cart-header">
    ...
    <?php if (!empty($cart)) { ?>
     <div class="giohang-header">
        ...
        <form action="<?= _WEB_ROOT ?>/Order/openOrderInCart" method="post">    
            <div class="giohang-container">
               <?php foreach($cart as $row) {
                ...
                <div class="giohang-col-5">
                    <input type="checkbox" name="idProduct[]" value="<?= $row['masp'] ?>">
                </div>
                <!-- Hiển thị ảnh + tên sản phẩm và số lượng -->
